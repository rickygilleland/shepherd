...
class ReportPostScreen extends React.Component {
			...
			<React.Fragment>
			     <View style={styles.view}>
			     	...
			     	<Header
					  ...
					  centerComponent={{ text: 'Report Post', style: { color: '#fff', fontFamily: 'Airbnb Cereal App' } }}
					/>
					
					<Text h4 style={{ fontFamily: 'Airbnb Cereal App', padding: 20 }}>Report a post</Text>
					<Text style={{ fontFamily: 'Airbnb Cereal App', paddingLeft: 20, paddingRight: 20 }}>Tell us why you would like to report this post.</Text>
